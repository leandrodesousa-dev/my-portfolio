            ...
            <div style={{ padding: '40px', maxWidth: '800px', margin: '0 auto' }}>
                ...
                <section className="profile-description">
                    ...
                    <p>
                        ...
                        ferramentas de IA (StackSpot/Copilot/Gemini) para aumentar drasticamente a produtividade.
                    </p>
                    <p>
                        Evolução de Produto: Modernizar a stack de analytics (GA4/DataDog) 
                        e garantir que o produto seja inclusivo, liderando frentes de Acessibilidade (WCAG 2.1 e UIAccessibility).
                    </p>
                    <p>
                        Seja refatorando um código legado, iniciando um projeto do zero com DDD e SOLID, 
                        ou integrando fluxos com Flutter, sou movido por desafios que exigem visão 
